...
create or replace function public.report_trial_balance(p_org_id uuid, p_as_of date)
...
create or replace function public.report_profit_and_loss(p_org_id uuid, p_start date, p_end date)
...
create or replace function public.report_balance_sheet(p_org_id uuid, p_as_of date)
returns table (account_code text, account_name text, account_type public.account_type, balance_cents bigint)
language plpgsql
security definer
stable
...
create or replace function public.report_general_ledger(p_org_id uuid, p_account_id uuid, p_start date, p_end date)
