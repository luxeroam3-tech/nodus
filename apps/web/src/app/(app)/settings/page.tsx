    ...
    <div>
      ...
      <div className="content-grid">
        <div className="card px-[18px] py-4">
          <h3 className="[font-family:var(--font-display)] text-[15px] font-semibold mb-1">Billing & Subscription</h3>
          <p className="text-[12.5px] text-[var(--text-muted)] mb-4">
            Currently on the <strong>{PLANS[(sub?.plan as keyof typeof PLANS) ?? "free"].name}</strong> plan.
          </p>
          <PrimaryLink href="/settings/billing">Manage plan</PrimaryLink>
        </div>
